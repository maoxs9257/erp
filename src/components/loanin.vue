<template>
	<el-dialog width='580px' v-dialogDrag title="新建借入" :visible.sync="visible" center>
		<div class='newIn'>
			<div class="item">
				<i class="iconfont kehu"></i>
				<el-input v-model="people" placeholder="债权人"></el-input>
			</div>
			<div class="item">
...
<script>
	export default {
		...
		methods: {
			...
			* @method createBorrow
			*/
			createBorrow(callback){
				if(!this.people) return this.$message.error('请输入债权人');
